...
<head>
<title>Application Level Protocols:proftpdio.d - DTraceBook</title>
...
wgNamespaceNumber=0,
wgPageName="Application_Level_Protocols:proftpdio.d",
wgTitle="Application Level Protocols:proftpdio.d",
wgAction="view",
wgArticleId=197,
wgIsArticle=true,
wgUserName=null,
...
<body class="mediawiki ltr ns-0 ns-subject page-Application_Level_Protocols_proftpdio_d skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content" >
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">Application Level Protocols:proftpdio.d</h1>
	<div id="bodyContent">
		<h3 id="siteSub">From DTraceBook</h3>
		<div id="contentSub"></div>
		<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>
		<!-- start content -->
<h1> <span class="mw-headline" id="proftpdio.d">proftpdio.d</span></h1>
<pre>
#!/usr/sbin/dtrace -s
...
<!-- Saved in parser cache with key wikidb:pcache:idhash:197-0!1!0!!en!2!edit=0 and timestamp 20131031143511 -->
<div class="printfooter">
Retrieved from "<a href="http://www.dtracebook.com/index.php/Application_Level_Protocols:proftpdio.d">http://www.dtracebook.com/index.php/Application_Level_Protocols:proftpdio.d</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-main" class="selected"><a href="/index.php/Application_Level_Protocols:proftpdio.d" title="View the content page [c]" accesskey="c">Page</a></li>
				 <li id="ca-talk" class="new"><a href="/index.php?title=Talk:Application_Level_Protocols:proftpdio.d&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				 <li id="ca-viewsource"><a href="/index.php?title=Application_Level_Protocols:proftpdio.d&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></li>
				 <li id="ca-history"><a href="/index.php?title=Application_Level_Protocols:proftpdio.d&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Application_Level_Protocols:proftpdio.d" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Application_Level_Protocols:proftpdio.d" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/Application_Level_Protocols:proftpdio.d" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="List of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-print"><a href="/index.php?title=Application_Level_Protocols:proftpdio.d&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>				<li id="t-permalink"><a href="/index.php?title=Application_Level_Protocols:proftpdio.d&amp;oldid=255" title="Permanent link to this revision of the page">Permanent link</a></li>			</ul>
		</div>
	</div>
...
<div id="footer">
	...
	<ul id="f-list">
		...
		<li id="viewcount">This page has been accessed 477 times.</li>
